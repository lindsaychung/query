...
app = Flask(__name__)
e = create_engine('mysql+pymysql://root:ilovehifi@localhost/hifitrackD72?charset=utf8', pool_size=20, max_overflow=20, pool_timeout=5)
...
class cart_add(Resource):
    ...
    def get(self, order_id, product_id, language, type):
        ...
        if type=="flac":
            ...
            wav_file_name_only = wav_file_name_only + str(random.randint(1,101))  # deal with multiple version of song working on the same temp file
